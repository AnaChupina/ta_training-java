package com.epam.training.student_anastasiia_chupina.fourteenth;
...
class CodeComplianceTest {
    ...
    void testFields() {
        ...
        spoon.addInputResource("src/main/java/com/epam/training/student_anastasiia_chupina/fourteenth");
        spoon.buildModel();
